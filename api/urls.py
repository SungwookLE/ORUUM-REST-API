...
from api.views import Stock_List_ListCreateAPIView, Stock_List_RetrieveUpdateAPIView, Stock_Information_History_ListCreateAPIView, Stock_Information_History_ViewSet, Stock_Price_History_ViewSet
...
urlpatterns = [
    ...
    path('stockinformationhistory/<str:ticker>/', Stock_Information_History_ViewSet.as_view(actions={
        'get':'list'
    }), name='stock_information_history-ticker-detail'),
    path('stockinformationhistory/<str:ticker>/<date:date>', Stock_Information_History_ViewSet.as_view(actions={
        'get':'retrieve'
    }), name='stock_information_history-date-detail'),
